...
CmpNode::CmpNode()
	:m_int_set(false),m_like_cmp(CMP_LIKE_TYPE_UNLIKE),m_equal_type(EQUAL_TYPE_EQUAL)
{

}

CmpNode::CmpNode(int column)
	:DataNode(column),m_int_set(false),m_like_cmp(CMP_LIKE_TYPE_UNLIKE),m_equal_type(EQUAL_TYPE_EQUAL)
{
