...
public:
	...
	const	char & GetBype() const	{ return m_char; }
...
public:
	...
	void SetLong64Set(const std::vector<long long> &long64set);
...
struct OrderType
{
	...
	OrderType(const OrderType& oder_type);
